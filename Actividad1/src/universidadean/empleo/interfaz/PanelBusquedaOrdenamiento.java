...
public class PanelBusquedaOrdenamiento extends JPanel implements ActionListener {
    ...
    private static final String BUSCAR2 = "Buscar Binario";
    ...
    public PanelBusquedaOrdenamiento(InterfazBolsaDeEmpleo interfaz) {
        ...
        botonOrdenarEdad = new JButton("Ordenar por Nombre");
        botonOrdenarEdad.setActionCommand(ORDENAR_NOMBRE);
        ...
        botonBuscar = new JButton("Buscar Aspirante (Binario) ");
        botonBuscar.setActionCommand(BUSCAR2);
        botonBuscar.addActionListener(this);
        gbc.gridy = 5;
        add(botonBuscar, gbc);
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        else if (BUSCAR2.equals(comando)) {
            principal.buscar2();
        }
    }
